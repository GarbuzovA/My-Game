...
bird.src = "images-moon/birdMoon.png";
pipeTop.src = "images-moon/pipeTopMoon.png";
pipeBottom.src = "images-moon/pipeBottomMoon.png";
backGround.src = "images-moon/backGroundMoon.jpg";
bl.src = "images-moon/bl.png";
...
score_audio.src = "audio-moon/score.mp3";
fail_audio.src = "audio-moon/fail.mp3";

// general settings
let gamePlaying = false;
const gravity = .5;   
const speed = 5.2; //6.2
const size = [56, 49];// 51 (36) bird54 42
const jump = -11.5;
...
// pipe settings
const pipeWidth = 78; 
const pipeGap = 270; //зазор 
const pipeLoc = () => (Math.random() * ((canvas.height - (pipeGap + pipeWidth)) - pipeWidth)) + pipeWidth; //pipe placement

const setup = () => {
  currentScore = 0;
  flight = jump;

  // middle of screen - size of the bird
